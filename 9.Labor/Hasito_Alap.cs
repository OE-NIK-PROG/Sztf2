...
namespace program
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
			...
			vasarlok[bela.ID].OrderedProducts.Add(new Product() { ID = 32, Name = "HotDog", Price = 550 });
			vasarlok[vivi.ID].OrderedProducts.Add(new Product() { ID = 2, Name = "Pizza", Price = 850 });
			vasarlok[vivi.ID].OrderedProducts.Add(new Product() { ID = 19, Name = "Apple", Price = 120 });
